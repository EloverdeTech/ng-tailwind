...
import { NgtSelectSearchConfig } from './ngt-select-search.config';
import { NgtSelectStateService } from './ngt-select-state.service';

@Injectable({ providedIn: null })
export class NgtSelectSearchService {
    ...
    public loadRemoteData(config: NgtSelectSearchConfig, filters: any = {}): void {
    ...
    public setCompareWithFn(compareWith: (a: any, b: any) => boolean): void {
        this.compareWithFn = compareWith;
    }
