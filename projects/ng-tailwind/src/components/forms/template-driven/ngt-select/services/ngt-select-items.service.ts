import { Injectable, OutputEmitterRef, signal, WritableSignal } from '@angular/core';
import { Observable, Observer, Subject } from 'rxjs';
import { NgtSelectSearchService } from './ngt-select-search.service';

export interface NgtSelectItemsConfig {
    remoteResource: any;
...
export class NgtSelectItemsService {
    ...
    public initializeItems(config: NgtSelectItemsConfig): Observable<any> {
